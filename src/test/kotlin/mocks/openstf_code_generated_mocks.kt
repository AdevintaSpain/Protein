...
const val OPENSTF_INTERFACE_MOCK = "package com.mycompany.mylibrary\n" +
  "\n" +
  "import com.schibsted.retroswagger.AddUserDevicePayload\n" +
  ...
  "   * User Devices\n" +
  "   *\n" +
  "   * @param fields Fields query parameter takes a comma seperated list of fields. Only listed field\n" +
  "   * will be return in response\n" +
  "   */\n" +
  "  @GET(\"user/devices\")\n" +
  ...
  "  fun getUserDeviceBySerial(@Path(\"serial\") serial: String, @Query(\"fields\") fields: String?):\n" +
  ...
  "  fun remoteConnectUserDeviceBySerial(@Path(\"serial\") serial: String):\n" +
  "      Single<RemoteConnectUserDeviceResponse>\n" +
  "\n" +
  "  /**\n" +
  "   * Remote Disconnect\n" +
  "   *\n" +
  ...
  "   */\n" +
  "  @GET(\"devices/{serial}\")\n" +
  "  fun getDeviceBySerial(@Path(\"serial\") serial: String, @Query(\"fields\") fields: String?):\n" +
  "      Single<DeviceResponse>\n" +
  "}\n"