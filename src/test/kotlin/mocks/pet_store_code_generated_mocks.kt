...
const val PET_STORE_INTERFACE_MOCK = "package com.mycompany.mylibrary\n" +
  "\n" +
  "import com.schibsted.retroswagger.Order\n" +
  "import com.schibsted.retroswagger.Pet\n" +
  "import com.schibsted.retroswagger.User\n" +
  ...
  "   */\n" +
  "  @GET(\"user/login\")\n" +
  "  fun loginUser(@Query(\"username\") username: String, @Query(\"password\") password: String):\n" +
  "      Completable\n" +
  "\n" +
  "  /**\n" +
