...
const val PET_STORE_INTERFACE_MOCK = "package com.mycompany.mylibrary\n" +
    ...
    "    @PUT(\"/pet\")\n" +
    "    fun updatePet(@Body body: Body): Completable\n" +
    "\n" +
    "    @POST(\"/pet\")\n" +
    "    fun addPet(@Body body: Body): Completable\n" +
    "\n" +
    ...
    "\n" +
    "    @POST(\"/store/order\")\n" +
    "    fun placeOrder(@Body body: Body): Single<Order>\n" +
    "\n" +
    ...
    "\n" +
    "    @POST(\"/user\")\n" +
    "    fun createUser(@Body body: Body): Completable\n" +
    "\n" +
    ...
    "\n" +
    "    @PUT(\"/user/{username}\")\n" +
    "    fun updateUser(@Path(\"username\") username: String, @Body body: Body): Completable\n" +
    "\n" +
